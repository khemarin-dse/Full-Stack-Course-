    ...
    <div className="flex flex-col gap-5">
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-[13px] text-[#6B6882] mt-0.5">Track your savings toward each goal</p>
        </div>
        <Btn onClick={() => setShowModal(true)}>
          <i className="ti ti-plus text-[14px]"></i> Add goal
        </Btn>
      </div>

      {loadingGoals ? <Spinner /> : goals.length === 0 ? (
        <Card className="p-8">
          <Empty icon="ti-target" message="No goals yet. Click 'Add goal' to get started." />
        </Card>
      ) : (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-[12px] text-[#6B6882] mt-0.5">
                ...
                <div className="flex items-center gap-1.5 text-[12px] text-primary mt-1">
